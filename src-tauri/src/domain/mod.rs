...
//!
//! The archive / mod plumbing and the export pipeline are not here but in `infrastructure`, and the
//! app's own state, preferences and command handlers in `application` — see the module docs of each.
